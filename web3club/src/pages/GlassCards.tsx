...
import './GlassCards.css'; // Import the CSS file for styling

const GlassCards: React.FC = () => {
  return (
    <div className="container">
      <div data-text="BUILD" style={{ '--r': -15 } as React.CSSProperties} className="glass">
      ...
      <div data-text="PARTICIPATE" style={{ '--r': 5 } as React.CSSProperties} className="glass">
      ...
      <div data-text="SHARE" style={{ '--r': 25 } as React.CSSProperties} className="glass">
